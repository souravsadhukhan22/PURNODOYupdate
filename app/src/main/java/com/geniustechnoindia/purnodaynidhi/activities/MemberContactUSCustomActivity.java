...
import com.geniustechnoindia.purnodaynidhi.databinding.ActivityMemberContactUSCustomBinding;
...
public class MemberContactUSCustomActivity extends AppCompatActivity {
    private Toolbar mToolbar;
    private TextView mTv_toolbarTitle;

    private ActivityMemberContactUSCustomBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMemberContactUSCustomBinding.inflate(getLayoutInflater());
        ...
        new GetDataParserArray(this, APILinks.GET_COMPANY_DETAILS, true, response -> {
            if(response != null){
                if(response.length() > 0){
                    ...
                    Toast.makeText(MemberContactUSCustomActivity.this, "Details not found.", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(MemberContactUSCustomActivity.this, "Something went wrong.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(MemberContactUSCustomActivity.this, MemberDashboardActivity.class);
