...
public class ArrangerAccountOpeningActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView mTv_toolbarTitle,tvWalletBalance;
    ...
    private void getNomineeRelation(String url) {
        new GetDataParserArray(ArrangerAccountOpeningActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            @Override
            public void onGetResponse(JSONArray response) {
                if (response != null) {
                    ...
                    ArrayAdapter arrayAdapterRelation = new ArrayAdapter(ArrangerAccountOpeningActivity.this, R.layout.item_select_relation, arrayListRelation);
                    ...
                    ArrayAdapter arrayAdapterSecondApplicantRelation = new ArrayAdapter(ArrangerAccountOpeningActivity.this, R.layout.item_select_relation, arrayListRelation);
    ...
    private void getPlanTable(String url) {
        new GetDataParserArray(ArrangerAccountOpeningActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanTable = new ArrayAdapter(ArrangerAccountOpeningActivity.this, R.layout.item_select_plan_code, arrayListPlanTable);
    ...
    private void getPlanCode(String url) {
        new GetDataParserArray(ArrangerAccountOpeningActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanCode = new ArrayAdapter(ArrangerAccountOpeningActivity.this, R.layout.item_select_plan_code, arrayListPlanCode);
    ...
    private void getWalletBalance(String walletURL) {
        new GetDataParserObject(ArrangerAccountOpeningActivity.this, walletURL, true, response -> {
            try {
                if (response != null) {
    ...
    public void onClick(View v) {
        if (v == mBtn_submit) {
                                            ...
                                            if (!investmentDate.equals("")) {
                                                if(maturityDateInt != 0){
                                                    if(mTv_payByCashAmount.getText().toString().trim().length() > 0){
                                                        if(walletBalance > Double.parseDouble(mTv_payByCashAmount.getText().toString())){
            ...
            if (mTv_planAmount.getText().toString().trim().length() > 0) {
                ...
                //double amtPayPayU=Double.parseDouble(mTv_payByCashAmount.getText().toString())*1.18;
                double amountForPayUMoneyTwoPerc=Double.parseDouble(mTv_payByCashAmount.getText().toString())*.02;
                amountForPayUMoneyTwoPerc=amountForPayUMoneyTwoPerc*1.18;
                // double amtPayPayU=Double.parseDouble(mTv_payByCashAmount.getText().toString())+amountForPayUMoneyTwoPerc;
                double amtPayPayU=Double.parseDouble(mTv_payByCashAmount.getText().toString());
                //mTv_payUPaybleAmt.setText(String.format("%.2f",amtPayPayU));
                ...
                maturityAmt=(int)(mAmount * Double.parseDouble(mTv_depositAmount.getText().toString()));
                //mTv_maturityAmount.setText(String.valueOf(mAmount * Double.parseDouble(mTv_depositAmount.getText().toString())));
                mTv_maturityAmount.setText(String.valueOf(maturityAmt));

                if(planCode.equals("FD")){
                    mTv_payByCashAmount.setText(mTv_planAmount.getText().toString());
                    //amtPayPayU=Double.parseDouble(mTv_payByCashAmount.getText().toString())*1.18;
                    //amtPayPayU=Double.parseDouble(mTv_payByCashAmount.getText().toString())*1.2;
                    amtPayPayU=Double.parseDouble(mTv_payByCashAmount.getText().toString());
                    //mTv_payUPaybleAmt.setText(String.format("%.2f",amtPayPayU));
                    mEt_term.setText(String.valueOf(sterm));
                    mTv_depositAmount.setText(mTv_planAmount.getText().toString());
                    maturityAmt=(int)(mAmount * Double.parseDouble(mTv_depositAmount.getText().toString()));
                    //mTv_maturityAmount.setText(String.valueOf((mAmount * Double.parseDouble(mTv_depositAmount.getText().toString()))));
                    mTv_maturityAmount.setText(String.valueOf(maturityAmt));
                }
            ...
            datePickerDialog = new DatePickerDialog(ArrangerAccountOpeningActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
                ...
                if (response != null) {
                    if (response.length() > 0) {
                        try {
                            ...
                            mTie_nomineeMemberCode.setText(jsonObject.getString("NomineeCode"));
                            mTie_nomineeMemberName.setText(jsonObject.getString("Nominee"));
                            mTv_nomineeDob.setText(jsonObject.getString("NomineeDOB"));
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
    ...
    private void createPolicy(String url) {
        ...
        new PostDataParserObjectResponse(ArrangerAccountOpeningActivity.this, url, hashMap, true, new PostDataParserObjectResponse.OnGetResponseListner() {
            @Override
    ...
    private void showDialog(String title, String message, final boolean status) {
        ...
        alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (status) {
                    dialog.dismiss();
                    startActivity(new Intent(ArrangerAccountOpeningActivity.this, MainActivity.class));
                } else {
                    dialog.dismiss();
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home: {
                startActivity(new Intent(ArrangerAccountOpeningActivity.this, MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                break;
            }
        }
