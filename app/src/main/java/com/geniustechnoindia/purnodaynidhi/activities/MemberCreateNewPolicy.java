...
public class MemberCreateNewPolicy extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_create_new_policy);
    ...
    private void getNomineeRelation(String url) {
        new GetDataParserArray(MemberCreateNewPolicy.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            @Override
            public void onGetResponse(JSONArray response) {
                if (response != null) {
                    ...
                    ArrayAdapter arrayAdapterRelation = new ArrayAdapter(MemberCreateNewPolicy.this, R.layout.item_select_relation, arrayListRelation);
                    ...
                    ArrayAdapter arrayAdapterSecondApplicantRelation = new ArrayAdapter(MemberCreateNewPolicy.this, R.layout.item_select_relation, arrayListRelation);
    ...
    private void getPlanTable(String url) {
        new GetDataParserArray(MemberCreateNewPolicy.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanTable = new ArrayAdapter(MemberCreateNewPolicy.this, R.layout.item_select_plan_code, arrayListPlanTable);
    ...
    private void getPlanCode(String url) {
        new GetDataParserArray(MemberCreateNewPolicy.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanCode = new ArrayAdapter(MemberCreateNewPolicy.this, R.layout.item_select_plan_code, arrayListPlanCode);
    ...
    public void onClick(View v) {
        if (v == mBtn_submit) {
            ...
            datePickerDialog = new DatePickerDialog(MemberCreateNewPolicy.this, new DatePickerDialog.OnDateSetListener() {
                @Override
    ...
    private void createPolicy(String url) {
        ...
        new PostDataParserObjectResponse(MemberCreateNewPolicy.this, url, hashMap, true, new PostDataParserObjectResponse.OnGetResponseListner() {
            @Override
    ...
    private void showDialog(String title, String message, final boolean status) {
        ...
        alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (status) {
                    dialog.dismiss();
                    startActivity(new Intent(MemberCreateNewPolicy.this, MemberDashboardActivity.class));
                } else {
                    dialog.dismiss();
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home: {
                startActivity(new Intent(MemberCreateNewPolicy.this, MemberDashboardActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                break;
            }
        }
