...
public class MemberInvestmentCalcActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_investment_calc);
    ...
    public void onClick(View view) {
        ...
        if(view == mTv_selectInvestmentDate){
            ...
            datePickerDialog = new DatePickerDialog(MemberInvestmentCalcActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
    ...
    private void getMaturityDate(String url) {
        new GetDataParserArray(MemberInvestmentCalcActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            @Override
    ...
    private void getPlanCode(String url) {
        new GetDataParserArray(MemberInvestmentCalcActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanCode = new ArrayAdapter(MemberInvestmentCalcActivity.this, R.layout.item_select_plan_code, arrayListPlanCode);
    ...
    private void getPlanTable(String url) {
        new GetDataParserArray(MemberInvestmentCalcActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanTable = new ArrayAdapter(MemberInvestmentCalcActivity.this, R.layout.item_select_plan_code, arrayListPlanTable);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(MemberInvestmentCalcActivity.this, MemberDashboardActivity.class);
