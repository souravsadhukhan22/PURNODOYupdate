...
public class ArrInvestmentCalcActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(view == mTv_selectInvestmentDate){
            ...
            datePickerDialog = new DatePickerDialog(ArrInvestmentCalcActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
    ...
    private void getMaturityDate(String url) {
        new GetDataParserArray(ArrInvestmentCalcActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            @Override
    ...
    private void getPlanCode(String url) {
        new GetDataParserArray(ArrInvestmentCalcActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanCode = new ArrayAdapter(ArrInvestmentCalcActivity.this, R.layout.item_select_plan_code, arrayListPlanCode);
    ...
    private void getPlanTable(String url) {
        new GetDataParserArray(ArrInvestmentCalcActivity.this, url, true, new GetDataParserArray.OnGetResponseListener() {
            ...
            public void onGetResponse(JSONArray response) {
                ...
                ArrayAdapter arrayAdapterPlanTable = new ArrayAdapter(ArrInvestmentCalcActivity.this, R.layout.item_select_plan_code, arrayListPlanTable);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(ArrInvestmentCalcActivity.this, com.geniustechnoindia.purnodaynidhi.MainActivity.class);
